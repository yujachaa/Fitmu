  ...
  <div class="container">
    <div class="nav-btn">
      <div class="" role="group" aria-label="Basic radio toggle button group">
        <input type="radio" class="btn-check" name="btnradio" id="btnradio1" autocomplete="off" value=4 :checked="category == 4" @change="changeCategory(4)">
        <label class="btn radio-button" for="btnradio1">닭가슴살</label>

        <input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off" value= 5 :checked="category == 5" @change="changeCategory(5)">
        <label class="btn  radio-button" for="btnradio2">소시지</label>

        <input type="radio" class="btn-check" name="btnradio" id="btnradio3" autocomplete="off" value=6 :checked="category == 6" @change="changeCategory(6)">
        <label class="btn  radio-button" for="btnradio3">도시락</label>

        <input type="radio" class="btn-check" name="btnradio" id="btnradio4" autocomplete="off" value= 7 :checked="category == 7" @change="changeCategory(7)">
        <label class="btn  radio-button" for="btnradio4">간식</label>
      </div>
    </div>
  </div>
...
productStore.getCategoryList(4)
productStore.category = 4
