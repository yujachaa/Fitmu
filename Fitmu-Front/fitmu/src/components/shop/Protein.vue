  ...
  <div class="container">
    <div class="nav-btn">
      <div class="" role="group" aria-label="Basic radio toggle button group">
        <input type="radio" class="btn-check" name="btnradio" id="btnradio1" autocomplete="off" value=1 :checked="category == 1" @change="changeCategory(1)">
        <label class="btn radio-button" for="btnradio1">프로틴분말</label>

        <input type="radio" class="btn-check" name="btnradio" id="btnradio2" autocomplete="off" value=2 :checked="category == 2" @change="changeCategory(2)">
        <label class="btn  radio-button" for="btnradio2">프로틴음료</label>

        <input type="radio" class="btn-check" name="btnradio" id="btnradio3" autocomplete="off" value=3 :checked="category == 3" @change="changeCategory(3)">
        <label class="btn  radio-button" for="btnradio3">보충제</label>
      </div>
    </div>
  </div>
...
productStore.getCategoryList(1)
productStore.category = 1
